...
metadata {
	...
	definition (name: "Modified Power Outlet", namespace: "schroeder", author: "Dave Schroeder") {
		capability "Actuator"
		capability "Switch"
...
def powerConfig() {
	[
		...
		"zcl global send-me-a-report 0x0B04 0x050B 0x29 1 600 {64 00}",				//The send-me-a-report is custom to the attribute type for CentraLite
